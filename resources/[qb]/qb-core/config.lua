...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 15) -- Obtém max players do arquivo de configuração, padrão 48
QBConfig.DefaultSpawn = vector4(-1035.71, -2731.87, 12.86, 0.0)
QBConfig.UpdateInterval = 5 -- Com que frequência atualizar os dados do jogador em minutos
QBConfig.StatusInterval = 5000 --Com que frequência verificar o status de fome/sede em milissegundos
