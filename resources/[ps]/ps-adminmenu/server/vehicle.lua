...
RegisterNetEvent("ps-adminmenu:server:givecar", function(data, selectedData)
    ...
    -- Tradução das chaves do selectedData para pt-br
    local vehmodel = selectedData['Veículo'] and selectedData['Veículo'].value or selectedData['Vehicle'] and selectedData['Vehicle'].value
    ...
    local plate = (selectedData['Placa (Opcional)'] and selectedData['Placa (Opcional)'].value) or (selectedData['Plate (Optional)'] and selectedData['Plate (Optional)'].value) or vehicleData.plate
    local garage = (selectedData['Garagem (Opcional)'] and selectedData['Garagem (Opcional)'].value) or (selectedData['Garage (Optional)'] and selectedData['Garage (Optional)'].value) or Config.DefaultGarage
