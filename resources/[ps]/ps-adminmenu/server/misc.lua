...
RegisterNetEvent('ps-adminmenu:server:BanPlayer', function(data, selectedData)
    ...
    -- Tradução para pt-br dos campos do selectedData
    local player = selectedData["Jogador"] and selectedData["Jogador"].value or selectedData["Player"].value
    local reason = (selectedData["Motivo"] and selectedData["Motivo"].value) or (selectedData["Reason"] and selectedData["Reason"].value) or ""
    local time = (selectedData["Duração"] and selectedData["Duração"].value) or (selectedData["Duration"] and selectedData["Duration"].value)
...
RegisterNetEvent('ps-adminmenu:server:WarnPlayer', function(data, selectedData)
    ...
    -- Tradução para pt-br dos campos do selectedData
    local targetId = (selectedData["Jogador"] and selectedData["Jogador"].value) or (selectedData["Player"] and selectedData["Player"].value)
    local reason = (selectedData["Motivo"] and selectedData["Motivo"].value) or (selectedData["Reason"] and selectedData["Reason"].value) or ""
...
RegisterNetEvent('ps-adminmenu:server:KickPlayer', function(data, selectedData)
    ...
    -- Tradução para pt-br dos campos do selectedData
    local target = (selectedData["Jogador"] and QBCore.Functions.GetPlayer(selectedData["Jogador"].value)) or QBCore.Functions.GetPlayer(selectedData["Player"].value)
    local reason = (selectedData["Motivo"] and selectedData["Motivo"].value) or (selectedData["Reason"] and selectedData["Reason"].value) or ""
...
RegisterNetEvent('ps-adminmenu:server:Revive', function(data, selectedData)
    local data = CheckDataFromKey(data)
    if not data or not CheckPerms(data.perms) then return end
    -- Suporte a pt-br e en nos campos
    local player = (selectedData["Jogador"] and selectedData["Jogador"].value) or (selectedData["Player"] and selectedData["Player"].value)
...
-- Revive Radius
RegisterNetEvent('ps-adminmenu:server:ReviveRadius', function(data, selectedData)
    local data = CheckDataFromKey(data)
    if not data or not CheckPerms(data.perms) then return end
...
RegisterNetEvent('ps-adminmenu:server:SetBucket', function(data, selectedData)
    ...
    -- Suporte a pt-br e en nos campos
    local player = (selectedData["Jogador"] and selectedData["Jogador"].value) or (selectedData["Player"] and selectedData["Player"].value)
    local bucket = (selectedData["Bucket"] and selectedData["Bucket"].value) or (selectedData["Balde"] and selectedData["Balde"].value)
...
RegisterNetEvent('ps-adminmenu:server:GiveMoney', function(data, selectedData)
    ...
    local src = source
    -- Suporte a pt-br e en nos campos
    local target = (selectedData["Jogador"] and selectedData["Jogador"].value) or (selectedData["Player"] and selectedData["Player"].value)
    local amount = (selectedData["Quantidade"] and selectedData["Quantidade"].value) or (selectedData["Amount"] and selectedData["Amount"].value)
    local moneyType = (selectedData["Tipo"] and selectedData["Tipo"].value) or (selectedData["Type"] and selectedData["Type"].value)
...
RegisterNetEvent('ps-adminmenu:server:ClothingMenu', function(data, selectedData)
    ...
    local src = source
    -- Suporte a pt-br e en nos campos
    local target = (selectedData["Jogador"] and tonumber(selectedData["Jogador"].value)) or tonumber(selectedData["Player"].value)
...
RegisterNetEvent("ps-adminmenu:server:setPed", function(data, selectedData)
    ...
    -- Suporte a pt-br e en nos campos
    local ped = (selectedData["Modelos de Ped"] and selectedData["Modelos de Ped"].label) or (selectedData["Ped Models"] and selectedData["Ped Models"].label)
    local tsrc = (selectedData["Jogador"] and selectedData["Jogador"].value) or (selectedData["Player"] and selectedData["Player"].value)
