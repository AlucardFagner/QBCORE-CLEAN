...
-- ----------------------------
-- Table structure for phone_chatroom_messages
-- ----------------------------
...
CREATE TABLE `phone_chatroom_messages`  (
  ...
  `member_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `member_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for phone_chatrooms
-- ----------------------------
...
CREATE TABLE `phone_chatrooms`  (
  ...
  `room_name` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `room_owner_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `room_owner_name` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `room_members` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `room_pin` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for phone_note
-- ----------------------------
...
CREATE TABLE `phone_note`  (
  ...
  `lastupdate` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `citizenid`(`citizenid` ASC) USING BTREE
...
-- ----------------------------
-- Table structure for player_jobs
-- ----------------------------
...
CREATE TABLE `player_jobs`  (
  ...
  `employees` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `maxEmployee` tinyint NULL DEFAULT 15,
  PRIMARY KEY (`id`) USING BTREE
